    ...
    def forward(
        ...
        *,
        ...
        if ablation_study is not None:
            if ablation_study["no_P"]:
                P_g = None
            if ablation_study["no_T"]:
                T_g = None
            if ablation_study["no_E"]:
                E_g = None
        ...
        if ablation_study is None and "E" in self.factors:
        ...
        if ablation_study is None and "T" in self.factors:
